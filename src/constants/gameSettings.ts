...
const PROFILES: Record<string, Partial<GameSettingsProfile>> = {
  ...
  aibullshit: {
    timerLabel: "編寫答案秒數",
    timerHint: "每人最多可寫 2 個假答案；全員按「完成」會提早進入投票。",
    timerMin: 45,
    timerMax: 120,
    defaultTimer: 60,
    maxRounds: 16,
  ...
  song3seconds: { timerMin: 6, defaultTimer: 10, defaultRounds: 10, maxRounds: 20 },
  kingtonight: { hasTimer: false, defaultRounds: 6, maxRounds: 20 },
  fireworkmaster: {
    timerLabel: "作畫秒數",
    timerHint: "每人在手機畫出自己的煙火，全員送出後一起施放，再投票。",
    timerMin: 30,
    timerMax: 120,
    defaultTimer: 60,
    maxRounds: 1,
  ...
  amongus: {
    timerLabel: "每輪任務秒數",
    timerHint: "時間到會自動召開會議；也可以隨時回報屍體或按緊急按鈕。",
    timerMin: 45,
    timerMax: 180,
    defaultTimer: 75,
    maxRounds: 1,
